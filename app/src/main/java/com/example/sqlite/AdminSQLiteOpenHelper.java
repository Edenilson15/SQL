...
public boolean consultaCodigo(Dto datos){
       ...
       try {int codigo = datos.getCodigo();
            Cursor fila = bd.rawQuery("select codigo, descripcion, precio from empleado where codigo=" + codigo,null);
            if(fila.moveToFirst()){
...
public boolean consultarDescripcion(Dto datos){
       ...
       try {
           String descripcion = datos.getDescripcion();
           Cursor fila = bd.rawQuery("select codigo, descripcion, precio from empleado where descripcion='" + descripcion + "'" ,null);
           if(fila.moveToFirst()){
               datos.setCodigo(Integer.parseInt(fila.getString(0)));
               datos.setDescripcion(fila.getString(1));
               datos.setPrecio(Double.parseDouble(fila.getString(2)));
...
public boolean bajaCodigo(final Context context, final Dto datos){
       ...
       try{
           int codigo = datos.getCodigo();
           Cursor fila = bd().rawQuery("select * from empleado where codigo=" + codigo,null);
           if (fila.moveToFirst()){
               datos.setCodigo(Integer.parseInt(fila.getString(0)));
               datos.setDescripcion(fila.getString(1));
               datos.setPrecio(Double.parseDouble(fila.getString(2)));
...
public boolean modificar (Dto datos){
       ...
       try {
           ...
           int cant = (int) bd.update("empleado",registro,"codigo=" + codigo,null);
           bd.close();
...
public ArrayList<Dto> consultaListaArticulos(){
       ...
       try{
           ...
           while (fila.moveToNext()){
               ...
               Log.i("tipo",articulos.getTipo().toString());
